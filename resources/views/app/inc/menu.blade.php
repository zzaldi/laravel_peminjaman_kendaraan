 <header class="navbar navbar-expand-md d-print-none dark">
     <div class="container-xl">
         ...
         <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
             <a href=".">
                 <img src="{{ asset('assets/static/zaldi.png') }}" width="110" height="32" alt="Tabler"
         ...
         <div class="navbar-nav flex-row order-md-last">
             <div class="nav-item dropdown">
                 <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                     ...
                     <div class="d-none d-xl-block ps-">
                         <div>Zaldi</div>
 ...
 <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
     <div class="container-fluid">
         ...
         <h1 class="navbar-brand navbar-brand-autodark">
             <a href=".">
                 <img src="assets/static/logo.svg" width="110" height="32" alt="Zaldi"
                     class="navbar-brand-image">
             </a>
         </h1>
             ...
             <ul class="navbar-nav pt-lg-3">
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu">
                         <a class="dropdown-item" href="{{ route('vehicles.login') }}" target="_blank"
                             rel="noopener">
                             login
                         </a>
                         <a class="dropdown-item" href="{{ route('vehicles.logout') }}">
                             admin
                         </a>
                         </a>
                     </div>
